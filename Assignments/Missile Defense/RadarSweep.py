...
"""
    ...
    File Description:
      This file runs the radar sweep which will detect missiles and build releveant
      SQL tables in postgres that can be utilized to fire a defensive missile and
