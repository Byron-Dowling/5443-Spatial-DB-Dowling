"""
    ...
    File Description:
      This file interacts with the Missile server to receive a GeoJSON
      bounding box that will serve as our region for the missile defense
      game. It is this region that we use to determine which incoming
      missiles are threats to us.
"""
